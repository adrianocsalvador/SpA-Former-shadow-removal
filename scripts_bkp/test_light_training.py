#!/usr/bin/env python3
"""
Script de teste usando o modelo SpA-Former Light para resolver o problema de memória
"""
...
class SimpleDataset:
    ...
    def __init__(self, num_samples=10):
        ...
        for i in range(num_samples):
            # Criar imagens dummy 3x256x256 (menor para economizar memória)
            shadow = torch.rand(3, 256, 256)
            shadow_free = torch.rand(3, 256, 256)
...
def test_light_training():
    """Teste de treinamento com modelo light"""
    print("🧪 Teste de treinamento com modelo Light...")
    ...
    # Testar modelos light
    print("\n🧪 Testando modelos Light...")
    
    try:
        # Importar SpA-Former Light
        sys.path.append('.')
        from SpA_Former_Light import SpA_Former_Light
        from models.dis.dis import Discriminator
        
        print("✅ Modelos importados com sucesso")
        
        # Criar modelos
        generator = SpA_Former_Light()
        ...
        # Criar dados de teste (256x256 para economizar memória)
        ...
        print("\n✅ Teste de treinamento Light concluído com sucesso!")
