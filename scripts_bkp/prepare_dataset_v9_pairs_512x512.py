#!/usr/bin/env python3
"""
Preparação do dataset_v9_pairs_512x512 usando apenas pares correspondentes
Organiza imagens com sombra (.jpeg) e sem sombra (.jpg) que têm o mesmo número
Versão adaptada para janelas 512x512
"""
...
def prepare_dataset_v9_pairs_512x512():
    """Prepara o dataset_v9_pairs_512x512 usando apenas pares correspondentes"""
    
    # Configurações
    base_dir = "/mnt/48EC7EE9EC7ED0A4/Teste_Sombra"
    dataset_dir = os.path.join(base_dir, "dataset_v9_pairs_512x512")
    ...
    print(f"📁 Criando dataset com pares 512x512 em: {dataset_dir}")
    ...
    print("\n✅ Dataset com pares 512x512 criado com sucesso!")
...
if __name__ == "__main__":
    prepare_dataset_v9_pairs_512x512()
